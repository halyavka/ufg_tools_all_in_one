...
public class MainPage {
 ...
 /*   public MainPage(final String userLogin) {
        userID = UserHelper.getUserIDByUserLogin(userLogin);
  ...
  /*  public MainPage(final String userLogin, boolean isDownloadProfileEnabled) {
        userID = UserHelper.getUserIDByUserLogin(userLogin);
       *//* new Thread(new Runnable() {
            @Override
            public void run() {
        ...
        createWebDriverFireFox(isDownloadProfileEnabled);
    }*/
